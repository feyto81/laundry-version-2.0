...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <a href="{{route('cms_users.create')}}" class="btn btn-success waves-effect btn-label waves-light"><i class="bx bxs-plus-square label-icon"></i> Add</a>
            </div>
        </div>
        <br>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge rounded-pill bg-info">{{$row->getRoleNames()->first()}}</span></td>
                                    @if ($row->status == 1)
                                    <td>
