...
class OutletController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.outlet.add', $data);
    }
    public function store(Request $request)
    {
        ...
        if ($request->submit == "more") {
            return redirect()->route('outlet.create')->with(['success' => 'Outlet has been saved !']);
        } else {
            return redirect()->route('outlet.index')->with(['success' => 'Outlet has been saved']);
        };
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // dd($user);
        if ($result) {
            return redirect()->route('outlet.index')->with(['success' => 'Outlet has been updated']);
        } else {
