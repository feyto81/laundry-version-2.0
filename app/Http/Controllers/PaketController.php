...
class PaketController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->submit == "more") {
            return redirect()->route('paket.create')->with(['success' => 'Paket has been saved !']);
        } else {
            return redirect()->route('paket.index')->with(['success' => 'Paket has been saved']);
        };
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // dd($user);
        if ($result) {
            return redirect()->route('paket.index')->with(['success' => 'Paket has been updated']);
        } else {
